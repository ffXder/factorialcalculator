...
public class SuggestedName {
	public static void main (String[]args) {
		...
		//it allows to input three names
		...
		//if the user enter a number within 1-6 it will display 
		// Using a string method charAt() to find the first character
		switch(num) {
		case 1:
			System.out.println("The initial for " + name1 + " " + name2 + " is: " + name1.toUpperCase().charAt(0)+ name2.toUpperCase().charAt(0));
			System.out.print("Suggested username: " + name1.toLowerCase() + "_" + name2.toLowerCase());
			break;
			
		case 2:
			System.out.println("The initial for " + name1 + " " + name3 + " is: " + name1.toUpperCase().charAt(0) + name3.toUpperCase().charAt(0));
			System.out.print("Suggested username: " + name1.toLowerCase() + "_" + name3.toLowerCase());
			break;
			
		case 3:
			System.out.println("The initial for " + name2 + " " + name1 + " is: " + name2.toUpperCase().charAt(0) + name1.toUpperCase().charAt(0));
			System.out.print("Suggested username: " + name2.toLowerCase() + "_" + name1.toLowerCase());
			break;
		
		case 4:
			System.out.println("The initial for " + name2 + " " + name3 + " is: " + name2.toUpperCase().charAt(0) + name3.toUpperCase().charAt(0));
			System.out.print("Suggested username: " + name2.toLowerCase() + "_" + name3.toLowerCase());
			break;
		
		case 5:
			System.out.println("The initial for " + name3 + " " + name1 + " is: " + name3.toUpperCase().charAt(0) + name1.toUpperCase().charAt(0));
			System.out.print("Suggested username: " + name3.toLowerCase() + "_" + name1.toLowerCase());
			break;
		
		case 6:
			System.out.println("The initial for " + name3 + " " + name2 + " is: " + name3.toUpperCase().charAt(0) + name2.toUpperCase().charAt(0));
